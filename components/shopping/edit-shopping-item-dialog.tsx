  ...
  return (
    <>
      ...
      <dialog
        ...
        className="m-auto max-h-[90vh] w-[min(720px,calc(100%-2rem))] rounded-xl border-0 bg-white p-0 text-foreground shadow-2xl backdrop:bg-black/50"
      >
        ...
        <form
          ...
          className="grid max-h-[calc(90vh-81px)] gap-4 overflow-y-auto p-5 sm:grid-cols-2"
        >
          ...
          <label className="grid gap-1.5 text-xs font-medium text-muted-foreground">
            ...
            <select
              ...
              className={fieldClass}
            >
              {Object.entries(shoppingStatusLabels).map(([value, label]) => (
